...
if (! $CI->db->table_exists($features_table)) {
    ...
    $CI->db->insert_batch($features_table, [
        ...
        [
            'feature_key'         => 'duplicate_wtl_form',
            'feature_name'        => 'Duplicate Web-to-Lead Form',
            'feature_description' => 'Browse all web-to-lead forms and duplicate any of them with a single click.',
            'category'            => 'leads',
            'is_active'           => 1,
            'activated_at'        => $now,
            'deactivated_at'      => null,
